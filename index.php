...
<head>
    ...
    <style>
        ...
        * {
        ...
        .quote-modal-overlay.show .quote-modal-content {
            transform: none;
        }
        ...
        .quote-modal-content .booking-form {
            box-shadow: none;
            padding: 0;
            margin: 0;
            max-width: none;
        ...
        @media (max-width: 900px) {
            ...
            /* Active marker as a transform-animated bar (stays on the compositor) */
            .main-nav a:not(.nav-cta-menu):not(.mobile-menu-call)::before {
                content: "";
                position: absolute;
                left: 8px;
                top: 10px;
            ...
            .main-nav a.active:not(.nav-cta-menu):not(.mobile-menu-call)::before {
                transform: scaleY(1);
            }
